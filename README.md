...
前端项目源码：https://github.com/Berger10086/user-center-front

后端项目源码：https://github.com/Berger10086/user-center-backend

## 项目截图

![QQ截图20230910111112](doc/pic/QQ截图20230910111112.png)

![QQ截图20230910111407](doc/pic/QQ截图20230910111407.png)

![QQ截图20230910111502](doc/pic/QQ截图20230910111502.png)

![QQ截图20230910111513](doc/pic/QQ截图20230910111513.png)
...
(
    ...
    userStatus   int      default 0                 not null comment '用户状态 0=正常 1=冻结',
...
- GenerateAllSetter：一键调用一个对象的所有的set方法,get方法等
- Auto Filling Java Call Arguments插件：自动填写Java参数
- `Shift + F6`:快速更改方法里所有参数名

### WebStorm

选中文本+按下`Shift + F6`全局替换
